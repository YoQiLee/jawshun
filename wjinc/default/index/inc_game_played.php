...
?>
<div style="background:url(/skin/main/images/newpng/a36.png) no-repeat;">
	<div class="game-btn2">
		<?php
			if($playeds) 
			{
	...
	<?php $this->display("index/inc_game_tips.php", 0 ,$this->played); ?>
	<div style="overflow:hidden;height:100%; background-color: #ECEDF1;; clear:both">
