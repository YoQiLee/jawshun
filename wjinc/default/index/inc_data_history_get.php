...
<tr align=center>
	...
	<td title='<?=$datan[0]?>'>
		<div class='periodlist'><?=$datan[0]?></div>
	</td>
	<td title='<?=$datan[1]?>'>
		<div class='periodlist'><?=$datan[1]?></div>
	</td>
</tr>
<?php }else{ ?>
<tr align=center>
	<td>
		<div style="color:#fff;" class='periodlist'><?=$var['number']?></div>
	</td>
	<td title='<?=$var['data']?>'>
		<div style="color:#feff65;" class='periodlist'></em><?=$var['data']?></em></div>
	</td>
</tr> 
<?php } } ?>